...
if "loaded_csv_signature" not in st.session_state:
    st.session_state.loaded_csv_signature = None
...
if uploaded is not None:
    ...
    # これをしないと、登録ボタンを押すたびに古いCSVで上書きされる。
    if st.session_state.loaded_csv_signature != csv_signature:
        ...
        if "hand" in raw.columns and "ev" in raw.columns:
            ...
            st.session_state.loaded_csv_signature = csv_signature
